 ...
 */
    ...
    if(!$admin->AdminIsLoggedIn()){
        $_SESSION['previous_page'] = 'OrderList.php';
...
<html lang="en">
  <head>
    ...
    <title>Bookers Heaven OrderList</title>
  ...
  <body>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="OrderList.php">Order List</a></li>
    ...
    <?php        
        $simplexml = $admin->GetOrderHistory();        
                            ...
                            <td class="status">
                                <?php 
                                    ...
                                    if($status == 1)
                                        ...
                                        $src = "http://localhost:8080/BookersHeaven/Presentation/DeliveryProduct.php?id=$shipment_id";
                                    ?>
                                    <form method="post" action = <?php echo $src; ?>>
                                        <input type="submit" value="Delivered" name="delivery">
                                    </form>
                                <?php } ?>                                                                                   
                            </td>
